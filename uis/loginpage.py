...
class Ui_LoginpageWindow(object):
    def setupUi(self, LoginpageWindow):
        ...
        LoginpageWindow.resize(552, 477)
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(30, 40, 491, 371))
        ...
        self.label_title = QtWidgets.QLabel(self.gridLayoutWidget_2)
...
"border-radius:11px;")
        ...
        self.label_wrong = QtWidgets.QLabel(self.gridLayoutWidget_2)
...
"border-color:white;")
        ...
        self.label_donthave = QtWidgets.QLabel(self.gridLayoutWidget_2)
