...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label_marek_desc = QtWidgets.QLabel(self.centralwidget)
        self.label_marek_desc.setObjectName("label_marek_desc")
        self.gridLayout_9.addWidget(self.label_marek_desc, 2, 1, 1, 1)
        spacerItem12 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_9.addItem(spacerItem12, 1, 0, 1, 1)
        self.label_marek_img = QtWidgets.QLabel(self.centralwidget)
        self.label_marek_img.setObjectName("label_marek_img")
        self.gridLayout_9.addWidget(self.label_marek_img, 1, 1, 1, 1)
        self.label_marek = QtWidgets.QLabel(self.centralwidget)
        self.label_marek.setAlignment(QtCore.Qt.AlignCenter)
        self.label_marek.setObjectName("label_marek")
        self.gridLayout_9.addWidget(self.label_marek, 0, 1, 1, 1)
        ...
        spacerItem17 = QtWidgets.QSpacerItem(120, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_marek_desc.setText(_translate("MainWindow", "Self developer"))
        self.label_marek_img.setText(_translate("MainWindow", "TextLabel"))
        self.label_marek.setText(_translate("MainWindow", "Marek Matys:"))
