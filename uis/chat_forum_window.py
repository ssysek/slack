...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textBrowser_message_in = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser_message_in.setObjectName("textBrowser_message_in")
        self.horizontalLayout_2.addWidget(self.textBrowser_message_in)
